...
export default function Tillage() {
    return (
        <GradientView rotate="-rotate-2">
            <div className="h-96 w-4/5 lg:w-3/5 absolute lg:right-12 self-center lg:self-auto self-end float-right shadow-xl bg-white rounded-3xl p-8 md:p-12 overflow-auto">
                <p className="font-bold text-4xl">Tillage</p>
