...
export default function MyTextArea({ label, placehodler, value, setValue, containerClassName = "", inputClassName = "" }) {
    ...
    return (
        <label className={"block " + containerClassName}>
            ...
            <textarea className={`form-input p-4 mt-2 block w-64 rounded-lg shadow-md
